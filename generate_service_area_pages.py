...
.page-hero{padding:calc(var(--nav-h)+56px) 44px 72px;background:linear-gradient(135deg,var(--navy) 0%,#0a3d36 100%);color:#fff;position:relative;min-height:560px;display:flex;align-items:center;}
...
.hero-inner{max-width:860px;margin:0 auto;position:relative;z-index:1;text-align:center;width:100%;}
...
.page-hero .subtitle{font-size:17px;color:rgba(255,255,255,0.75);line-height:1.75;max-width:620px;margin:0 auto 22px;}
.hero-btns{display:flex;gap:12px;flex-wrap:wrap;margin-bottom:24px;justify-content:center;}
.btn-primary{padding:13px 26px;background:var(--teal);color:#fff;border:none;border-radius:10px;font-size:15px;font-weight:700;cursor:pointer;text-decoration:none;display:inline-block;transition:all .15s;font-family:inherit;}
